...
class TestPiraCrew():
    ...
    @agent
    def reporting_analyst_1(self) -> Agent:
        return Agent(
            config=self.agents_config['reporting_analyst_1'], # type: ignore[index]
            verbose=True
        )

    @agent
    def reporting_analyst_2(self) -> Agent:
        return Agent(
            config=self.agents_config['reporting_analyst_2'], # type: ignore[index]
            verbose=True
        )
